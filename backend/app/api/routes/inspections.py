...
from backend.app.db.database import get_inspection, list_inspections, save_human_review
...
async def create_inspection_endpoint(
    ...
    try:
        return await run_in_threadpool(run_inspection, content, image.filename, bearing_type)
