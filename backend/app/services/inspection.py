...
from backend.app.schemas.inspection import ArtifactUrls, InspectionResponse
...
def run_inspection(content: bytes, filename: str | None, bearing_type: str) -> InspectionResponse:
    ...
    vlm = analyze(preprocessed.quality, vision, decision)
    ...
    create_inspection(
        {
            ...
            "geometry_result_json": json.dumps({"status": "planned"}),
